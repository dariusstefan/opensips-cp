...
The Clusterer tool maps over the [Clusterer OpenSIPS module](https://docs.opensips.org/manual/2-4/modules/clusterer), allowing full provisioning and monitoring of a cluster of OpenSIPS servers.
