...
A complete description of the Call Canter module functionlity can be found in [Call Center module documentation](https://docs.opensips.org/manual/2-3/modules/call_center)
