...
The OCP dialog tool comes to mapps over the [Dialog OpennSIPS module](https://docs.opensips.org/manual/2-3/modules/dialog)i (for keeping track of the ongoing SIP calls in OpenSIPS).
...
![Dialog Profiles](img/dialog_profile.jpg)
