...
The TCP Management tool maps over the [TCP Management (tcp_mgm) OpenSIPS module](https://docs.opensips.org/manual/3-6/modules/tcp_mgm), which provides SQL-based, fine-grained management of the TCP connections OpenSIPS opens or accepts.
