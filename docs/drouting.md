...
The Dynamic Routing OCP tool maps on the [Dynamic Routing (drouting) OpenSIPS module](https://docs.opensips.org/manual/2-3/modules/drouting). It is used for provisioning the OpenSIPS drouting information, to add, modify and delete the Gateways, Carriers and Rules.
