...
This tool maps over the [Dispatcher OpenSIPS module](https://docs.opensips.org/manual/2-4/modules/dispatcher), which implements a dispatching routing over a set of destination addresses.
