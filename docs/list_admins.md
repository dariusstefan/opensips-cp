---
title: 'List Admins Tool (list_admins)'
---

## Description

This tools allows listing, deleting and modifying the admins.

You can search by username, first name and last name, or show all records that are in the table. For each admin you can edit the personal info, which tools are available for him, and the type of acces (read-only / read-write) for each tool.
