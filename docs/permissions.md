...
The permissions tool maps on the [Permissions OpenSIPS module](https://docs.opensips.org/manual/2-4/modules/permissions), the addresses table. It is used for determining permission based on IP addresses or ranges of IPs.
