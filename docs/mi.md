...
MI stands for [Management Interface](https://docs.opensips.org/manual/2-4/interface-mi). The tool offers the possibility to execute commands - via the JSONRPC backend- on the OpenSIPS servers configured on the platform.
