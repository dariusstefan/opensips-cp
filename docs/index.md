---
title: 'Control Panel 9.4.1 documentation'
version: '9'
---
...
- Tools Configuration - detailed description
  ...
  - System Section - Tools for provisioning various non-subscriber features in OpenSIPS.
    ...
    - [Config](config.md) - provision OpenSIPS settings via a config table (starting with 9.3.5)
    ...
    - [Sockets Management](sockets_mgm.md) - provision OpenSIPS dynamic sockets through database (starting with 9.3.6)
